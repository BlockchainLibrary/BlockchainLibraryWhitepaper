...
\normalsize Open University \\ % Second author's institution
...
Borrow from the state of the art in publications (e.g. micropublications) and
libraries to support the Library Shelf and the Development Platform also using
